...
public class WsHttpRequestHandler extends SimpleChannelInboundHandler<Object> {
    /**
     * 读取完连接的消息后，对消息进行处理。
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        String wsAddress = "ws:/" + ctx.channel() + "/websocket";
        System.out.println(String.format("address:%s", wsAddress));

        WebSocketServerHandshakerFactory wsFactory = new WebSocketServerHandshakerFactory(wsAddress, null, false);
